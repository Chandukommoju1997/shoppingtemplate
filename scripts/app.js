...
function renderProductCard(product) {
  ...
  <div class="card"> <img src="${product.image}" class="card-img-top" alt="..." />
    <div class="card-body">
      <h5 class="card-title">${product.title}</h5>
      <p class="card-text">${product.description} </p>
      <div> <strong><span class="material-icons-outlined"> currency_rupee </span>${product.priceModified}</strong></div>
      <divclass="btn-group  role="group" aria-label="Basic example">
...
//forSearchconst
forSearch = document.getElementById("search");
  ...
  favoriteBtn$.forEach((btn$) => {
    btn$.addEventListener("click", (e) => {
      ...
      if (selectedProductIndex != -1) {
        ...
        icon.innerHTML = "material-icons-outlined";
      } else {
